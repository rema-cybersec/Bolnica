...
public class MainWindow extends JFrame {
    ...
    public MainWindow() {
        ...
        btnPreglediLekara.addActionListener(e -> new LekarPreglediWindow().setVisible(true));


        btnAdd.addActionListener(e -> new AddWindow(() -> reloadTable()).setVisible(true));
        btnDelete.addActionListener(e -> new DeleteWindow(() -> reloadTable()).setVisible(true));
    ...
    // TODO: dodaj ove loadove u neki kontroler
    ...
    private void reloadTable() {
        // nije potrebno lepo izgleda bez
    }
